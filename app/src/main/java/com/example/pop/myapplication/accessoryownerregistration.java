...
public class accessoryownerregistration extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener  {
    EditText name,address,contact,email,username,password,answer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accessoryownerregistration);
    ...
    class selstate extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                adapter = new ArrayAdapter<String>(accessoryownerregistration.this,android.R.layout.simple_spinner_item,states);
